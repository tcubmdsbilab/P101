// 請複製此檔案為 config.js，並填入您的 Supabase 專案資訊。
// 注意：config.js 可放 anon public key，但絕對不可放 service_role key。
window.P101_CONFIG = {
  SUPABASE_URL: "https://mfljkyvdadxlrbxlboce.supabase.co/rest/v1/",
